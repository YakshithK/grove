    ...
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      {glowing && (
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(145, 249, 229, 0.30) 0%, transparent 70%)",
            width: size * 1.8,
            height: size * 1.8,
            left: "50%",
            top: "50%",
      ...
      >
        ...
        <path
          ...
          fill="rgba(145, 249, 229, 0.12)"
          stroke="rgba(145, 249, 229, 0.25)"
          strokeWidth="1.2"
        />
      </svg>
    </div>
